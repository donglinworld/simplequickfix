...
public class Executor {
    ...
    public static void main(final String args[]) throws Exception {
        try {
            ...
            if ( engineobj instanceof EngineFactory ) {
                ...
                engine.initEngine("resources/executor.cfg");
    ...
    private static class _Application implements Application {
        ...
        @Override
        public void onRecvAppMessage(final Message message, final Session sessionId) {
            if ( MsgType.ORDER_SINGLE.equals(message.getMsgType()) ) {
                ...
                replyMsg.setValue(Tag.ExecType, "0");
                replyMsg.setValue(Tag.OrdStatus, "0");
                ...
                replyMsg.setValue(Tag.LeavesQty, message.getValue(Tag.OrderQty));
                replyMsg.setValue(Tag.CumQty, "0");
        ...
        @Override
        public void onSendAppMessage(final Message arg0, final Session arg1) {
            // ignore
